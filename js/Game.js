class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 140, y: height - 1400, image: obstacle2Image },
      { x: width / 2 + 240, y: height - 1500, image: obstacle2Image },
      { x: width / 2 - 140, y: height - 3600, image: obstacle2Image },
     
      { x: width / 2 - 140, y: height - 4300, image: obstacle1Image },
      { x: width / 2, y: height - 5300, image: obstacle1Image },
    ];
